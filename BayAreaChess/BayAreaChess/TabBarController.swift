...
class TabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        sidebar = FrostedSidebar(itemImages: imgList, colors: colorList, selectedItemIndices: selectedItemIndices);
        
//        sidebar = FrostedSidebar(itemImages: [
//            UIImage(named: "chevron-left"),
//            UIImage(named: "chevron-left1"),
//            UIImage(named: "chevron-left2"),
//            UIImage(named: "chevron-left3")],
//            colors: [
